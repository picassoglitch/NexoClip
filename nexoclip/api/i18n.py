...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "newClip.url.cookiesPre": "Kick + age-gated YouTube need",
        "newClip.url.cookiesMid": "in the server's",
    ...
    "es": {
        ...
        "newClip.url.cookiesPre": "Kick y YouTube con restricción de edad necesitan",
        "newClip.url.cookiesMid": "en el",
