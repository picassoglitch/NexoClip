...
-- Postgres baseline equivalent to SQLite migrations through v50.
...
CREATE TABLE autopublish_settings (
    ...
    updated_at  TEXT NOT NULL, score_threshold double precision NOT NULL DEFAULT 0.6, tag_suffix TEXT NOT NULL DEFAULT '', content_strategy TEXT NOT NULL DEFAULT 'unique',
