...
async def test_apply_migrations_brings_empty_db_to_version_1(db: Database) -> None:
...
async def test_schema_creates_all_phase_1_tables(migrated_db: Database) -> None:
